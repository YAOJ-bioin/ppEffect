...
An example report can be obtained here: [ppEffect_eval_report-example](./man/ppEffect_eval_report-example.html) (Sorry about that, but github can’t show files that are this big right now. Please download the file to open it.)
