...
#'
#' @param object A seruat object, which have been pre-processed (after normalization, dimension reduction, and marker gene identification).
#' @param ppDEGs a vector of protoplasting induced genes. You can obtain the dataset from ppDEGs_DB or input your own geneList.
#' @param group.by a slot to group cells. The default is "suerat_clusters".
#' @param marker_genes a data.frame about marker_genes, We recommend you produce it from the seurat function "FindAllMarkers"
...
eval_ppEffect <- function(object, ppDEGs,group.by ="seurat_clusters",marker_genes,report_dir="./ppEffect_report.html" ,...) {
  ...
  featurePlotCols=c("lightgrey","lightgrey","lightgrey","#ffffcc","#ffeda0","#fed976",
                    "#feb24c","#fd8d3c","#fc4e2a","#e31a1c","#bd0026","#800026","#800026")
  selCols=(c("#DCB717","#E2272E","#5EA5C9","#76AB62","#91217F","#fdb462","#EA9014","#5A7FB9","#757C98","#178F3B",
